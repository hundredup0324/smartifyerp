...
import '../utils/base_api_sales.dart';
...
class NetworkHttps {
  ...
  static Future getRequest(String endPoint) async {
    var getUrl = API.apiUrl + endPoint;
  ...
  static Future postRequest(String endPoint, Map data) async {
    String postUrl = API.apiUrl + endPoint;
  ...
  static Future deleteRequest(String endPoint) async {
    String deleteUrl = API.apiUrl + endPoint;
    try {
