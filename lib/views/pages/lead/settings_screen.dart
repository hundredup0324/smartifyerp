...
import 'package:attendance/utils/ui_text_style.dart';
import 'package:attendance/views/pages/lead/change_password.dart';
import 'package:attendance/views/pages/lead/edit_profile_screen.dart';
import 'package:attendance/views/pages/attendence/login_screen.dart';
import 'package:attendance/views/pages/lead/workspace_screen.dart';
import 'package:attendance/views/pages/attendence/menu_screen.dart';
import 'package:attendance/views/widgets/common_space_divider_widget.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  final LeadSettingController settingController = Get.put(LeadSettingController());
