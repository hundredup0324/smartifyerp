...
class ChangeLeadStage extends StatelessWidget {
  String? leadId;

  ChangeLeadStage({super.key, this.leadId});
              ...
              Expanded(
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      var data = leadController.leadBoardList[index];

                      return Obx(() {
                        return GestureDetector(
                            onTap: () {
                              leadController.selectedTaskStages.value = index;
                              leadController.selectedTaskStagesId.value =
                                  data.id ?? 0;
                              leadController.currentTaskStages.value =
                                  data.name.toString();
                              leadController.leadBoardList.refresh();
                            },
              ...
              CommonButton(
                onPressed: () {
                  if (Prefs.getBool(AppConstant.isDemoMode) == true) {
                    ...
                    Get.back();
                    leadController.changeStages(leadId ?? "",
                        leadController.selectedTaskStagesId.value.toString());
                  }
                },
                title: "Update",
              ),
